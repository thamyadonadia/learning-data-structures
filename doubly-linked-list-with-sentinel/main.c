...
int main(){
    ...
    printf("3. Imprimir todos os alunos do inicio ao fim\n4. Imprimir todos os alunos do fim ao inicio\n");
    ...
    while(op!=5){
        ...
        case 3: 
            printf("-------------------- Lista de alunos do inicio ao fim --------------------\n");
            imprimeLista(lista, 1);

            break;
        
        case 4: 
            printf("-------------------- Lista de alunos do fim ao inicio --------------------\n");
